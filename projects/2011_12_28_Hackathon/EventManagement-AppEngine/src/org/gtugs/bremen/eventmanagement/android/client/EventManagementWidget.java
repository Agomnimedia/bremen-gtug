 ...
 *******************************************************************************/
package org.gtugs.bremen.eventmanagement.android.client;
...
import org.gtugs.bremen.eventmanagement.android.client.MyRequestFactory.MessageRequest;
import org.gtugs.bremen.eventmanagement.android.shared.MessageProxy;

public class EventManagementWidget extends Composite {
  ...
  interface EventManagementUiBinder extends UiBinder<Widget, EventManagementWidget> {
  }

  private static EventManagementUiBinder uiBinder = GWT.create(EventManagementUiBinder.class);
